...
const translations = {
  en: {
    ...
    'consent.body': 'TravelMap stores the profile from your Google or Apple sign-in (name, email address, and a profile picture if the provider shares one) and the travel data you add, meaning cities, countries, friends and groups, with Google Firebase so the app can work. Details:',
    'consent.privacyLink': 'Privacy Policy',
    'consent.accept': 'Agree and continue',
    'consent.decline': 'Decline',
    // Login page
    'auth.tagline': 'Track your travels on the world map',
    'offline.message': 'No connection. You can keep using the app: search, add and edit places. Everything syncs once you are back online.',
    'offline.ok': 'Got it',
    'online.flash': 'Back online, syncing your changes',
  ...
  de: {
    ...
    'consent.body': 'TravelMap speichert das Profil aus deiner Anmeldung mit Google oder Apple (Name, E-Mail-Adresse und, falls der Anbieter eines herausgibt, ein Profilbild) und die Reisedaten, die du einträgst, also Städte, Länder, Freunde und Gruppen, bei Google Firebase, damit die App funktioniert. Details:',
    ...
    'offline.message': 'Kein Netz. Du kannst alles weiter nutzen: suchen, eintragen und ändern. Sobald du wieder online bist, wird alles synchronisiert.',
    'offline.ok': 'Verstanden',
    'online.flash': 'Wieder online, deine Änderungen werden übertragen',
